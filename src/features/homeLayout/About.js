...
const About = () => {
  return (
    <>
    <div id='about' className="min-h-screen border-y border-b-0 border-green-300 flex flex-col text-white justify-between items-center lg:flex-row max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-4 mb-4">
